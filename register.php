...
if (isset($_POST['register_button'])) {
    ...
    if (empty($error_array)) {
        ...
        while (mysqli_num_rows($check_username_query) != 0) {
            ...
            $check_username_query =  mysqli_query($con, "SELECT username FROM users username = '$username'");
        }
...
<body>
    <form action="register.php" method="POST">
        ...
        <?php if (in_array("Your first name must be between 2 to 30 characters<br>", $error_array)) echo "Your first name must be between 2 to 30 characters<br>"; ?>
        ...
        <input type="text" name="reg_lname" placeholder="Last Name" value="<?php
                                                                            ...
                                                                            ?>" required>
        <br>
        <?php if (in_array("Your last name must be between 2 to 30 characters<br>", $error_array)) echo "Your last name must be between 2 to 30 characters<br>"; ?>
